...
**55/100** AI readability · HTTP 200 · 0 words in the initial HTML
...
| ✅ | Entity structured data | 10/10 | JSON-LD: organization, product, softwareapplication, breadcrumblist. |
| ⚠️ | Tables and lists | 0/8 | No tables and fewer than three list items. Comparative facts lift better from tables. |
| ✅ | Title and meta description | 5/5 | Title 61 chars, description 151 chars. |
