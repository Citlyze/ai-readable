...
**95/100** AI readability · HTTP 200 · 2111 words in the initial HTML
...
| ⚠️ | One descriptive H1 | 5/10 | 2 H1s found: "Start free, then scale your site" and 1 more. Use one. |
| ✅ | Question-shaped headings | 12/12 | 11 of 16 subheadings are questions (for example "What are credits?"). |
...
| ✅ | Tables and lists | 8/8 | 0 tables, 215 list items. |
| ✅ | Title and meta description | 5/5 | Title 15 chars, description 151 chars. |
