...
**78/100** AI readability · HTTP 200 · 5306 words in the initial HTML
...
| ✅ | One descriptive H1 | 10/10 | H1: "Choose a paid plan built for businesses.". |
| ❌ | Question-shaped headings | 0/12 | 0 of 6 subheadings are questions. |
...
| ✅ | Tables and lists | 8/8 | 1 table, 301 list items. |
| ✅ | Title and meta description | 5/5 | Title 61 chars, description 149 chars. |
